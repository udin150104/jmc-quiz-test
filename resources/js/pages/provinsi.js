export function init() {
  ...
  $(document).on('click', '.btn-edit', function () {
    ...
    $.get(`/application/referensi/provinsi/${id}`, function (response) {
  ...
  $(document).on('click', '.delete-action', function () {
    ...
    $.ajax({
      url: `/application/referensi/provinsi/${initdel}`,
      type: 'DELETE',
  ...
  $(document).on("click", "#submit-action", function () {
    ...
    const url = id ? `/application/referensi/provinsi/${id}` : '/application/referensi/provinsi';
  ...
  function loadData(page = 1) {
    ...
    $.get('/application/referensi/provinsi/api/data', {
      page: page,
      search: search,
    }, function (response) {
      let html = '';
      ...
      if (response.data.length > 0) {
        ...
        html += `<tr><td colspan="2" class="text-muted">Belum Ada Data</td></tr>`;
      }
